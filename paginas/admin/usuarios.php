                            ...
                            <?php while($row = mysqli_fetch_assoc($resultado)) { ?>
                                <tr class="border-bottom">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <?php elseif($row['rol'] == 'repartidor'): ?>
                                            <span class="badge bg-warning-subtle text-warning-emphasis border border-warning-subtle px-3 py-1.5 rounded-pill small fw-bold">Repartidor</span>
                                        <?php else: ?>
